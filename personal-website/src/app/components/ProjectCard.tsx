...
export default function ProjectCard(props: ProjectCardProps) {
    return (
      <>
        <div className="grid-cols-3 gap-3 h-24 max-w-2xl w-3/4 bg-slate-800 rounded-lg p-2 flex shadow-inner-top hover:bg-gradient-to-r from-cyan-500/[.15] to-purple-500/[.15]">
